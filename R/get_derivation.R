...
get_derivation <- function(
    ...
    if (is.null(control$replace)          || typeof(control$replace) != "logical"          || length(control$replace) > 1)          control$replace <- FALSE
    ...
    if (is.null(control$derive_all)       || typeof(control$derive_all) != "logical"       || length(control$derive_all) > 1)       control$derive_all <- FALSE
    ...
    return(res[c(
        TRUE,
        control$formula,
        control$draw_derivation && !control$draw_all,
        control$draw_derivation && control$draw_all,
        control$benchmark
    )])
