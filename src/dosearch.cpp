    ...
    const bool& verbose)
{
    ...
    formulasearch s(n, draw_derivation, draw_all, derive_all, formula, improve, md_sym, heuristic, replace, verbose); //remember non-interventional vars
